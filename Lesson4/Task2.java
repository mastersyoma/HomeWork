...
class DividingByZeroException extends Exception {
...
class Div {
    ...
    double getDiv(double a, double b) throws DividingByZeroException {
        if (b == 0) throw new DividingByZeroException("Деление на ноль запрещено!!!!");
        return a / b;
    }
